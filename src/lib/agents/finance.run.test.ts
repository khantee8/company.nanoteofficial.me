...
describe('finance.run with MCP', () => {
  it('calls completeRaw on Sonnet, hybrid web_search + MCP (v1.12 — the batch substrate removed the 300s cap)', async () => {
    ...
    expect(opts.webSearch).toBe(true); // hybrid: web_search runs alongside MCP now
