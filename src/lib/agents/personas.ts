...
3) ## Flags — รายการ bullet 0-3 ข้อของสิ่งที่แผนกอื่นต้องทำต่อ "สองภาษา": bullet ภาษาไทยก่อน แล้วบรรทัด <!-- ===EN=== --> แล้วตามด้วย bullet ชุดเดียวกันเป็นภาษาอังกฤษ ถ้าไม่มี flag เลย ให้เขียนเพียง "None." บรรทัดเดียว (ไม่ต้องมีบรรทัดคั่น)
